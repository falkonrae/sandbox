...
void		    ft_pipe_center(t_strt *strt, int **pipes, char *str, t_shell *data);
...
pid_t			ft_pipes_exec(t_strt *strt, int **pipes, int size, t_shell *data);
